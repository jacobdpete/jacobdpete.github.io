...
const MenuBar: QuartzComponent = ({ fileData, displayClass }: QuartzComponentProps) => {
  ...
  const isEtcetera = slug === "Fiction" || slug === "Fiction-Index" || slug === "Commentary" || slug === "Commentary-Index" || slug === "Graph" || slug === "Recent-Updates" || slug === "Etcetera"
  ...
  return (
    <div class={classNames(displayClass, "menu-bar")}>
      ...
      <ul class="top-tier">
        ...
        <li>
          <a href="/Etcetera" class={isEtcetera ? "active" : ""}>
      ...
      {isWiki && (
        <div class="sub-tier-container">
          <ul class="sub-tier">
            <li>
              <a href="/Culture" class={slug === "Culture" ? "active" : ""}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/><path d="M2 12h20"/></svg>
                Culture
              </a>
            </li>
            <li>
              <a href="Economics-and-Technology/Economics-and-Technology-Index" class={slug === "Economics-and-Technology-Index" ? "active" : ""}>
            ...
            <li>
              <a href="History/History-Index" class={slug === "History-Index" ? "active" : ""}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                History
              </a>
            </li>
            <li>
              <a href="/People" class={slug === "People" ? "active" : ""}>
            ...
            <li>
              <a href="/Places" class={slug === "Places" ? "active" : ""}>
            ...
            <li>
              <a href="Politics/Politics-Index" class={slug === "Politics-Index" ? "active" : ""}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 10v6M2 10v6M12 2 2 7l10 5 10-5z"/><path d="M6 12v5c0 2 2 3 6 3s6-1 6-3v-5"/></svg>
                Politics
              </a>
            </li>
            <li>
              <a href="/States" class={slug === "States" ? "active" : ""}>
      ...
      {isEtcetera && (
        <div class="sub-tier-container">
          <ul class="sub-tier">
            <li>
              <a href="Fiction/Fiction-Index" class={slug === "Fiction-Index" ? "active" : ""}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>
                Fiction
              </a>
            </li>
            <li>
              <a href="Commentary/Commentary-Index" class={slug === "Commentary-Index" ? "active" : ""}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
                Commentary
              </a>
            </li>
            <li>
              <a href="/Graph" class={slug === "Graph" ? "active" : ""}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/></svg>
                Graph View
              </a>
            </li>
            <li>
              <a href="/Recent-Updates" class={slug === "Recent-Updates" ? "active" : ""}>
