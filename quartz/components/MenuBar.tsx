...
const MenuBar: QuartzComponent = ({ fileData, displayClass }: QuartzComponentProps) => {
  ...
  // Upgraded to .includes() to make it universally catch any file inside these folders!
  const isEtcetera = slug.includes("Fiction") || slug.includes("Commentary") || slug.includes("Graph") || slug.includes("Recent-Updates") || slug === "Etcetera"
    ...
    <div class={classNames(displayClass, "menu-bar")}>
      ...
      {isWiki && (
        <div class="sub-tier-container">
          <ul class="sub-tier">
            <li>
              <a href="/Culture" class={slug.includes("Culture") ? "active" : ""}>
            ...
            <li>
              <a href="/Economics-and-Technology/Economics-and-Technology-Index" class={slug.includes("Economics") ? "active" : ""}>
            ...
            <li>
              <a href="/History/History-Index" class={slug.includes("History") ? "active" : ""}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                History
              </a>
            </li>
            <li>
              <a href="/People" class={slug.includes("People") ? "active" : ""}>
            ...
            <li>
              <a href="/Places" class={slug.includes("Places") ? "active" : ""}>
            ...
            <li>
              <a href="/Politics/Politics-Index" class={slug.includes("Politics") ? "active" : ""}>
            ...
            <li>
              <a href="/States" class={slug.includes("States") ? "active" : ""}>
      ...
      {isEtcetera && (
        <div class="sub-tier-container">
          <ul class="sub-tier">
            <li>
              <a href="/Fiction/Fiction-Index" class={slug.includes("Fiction") ? "active" : ""}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>
                Fiction
              </a>
            </li>
            <li>
              <a href="/Commentary/Commentary-Index" class={slug.includes("Commentary") ? "active" : ""}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
                Commentary
              </a>
            </li>
            <li>
              <a href="/Graph" class={slug.includes("Graph") ? "active" : ""}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/></svg>
                Graph View
              </a>
            </li>
            <li>
              <a href="/Recent-Updates" class={slug.includes("Recent-Updates") ? "active" : ""}>
